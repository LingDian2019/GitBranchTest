...
namespace FrameworkCoreWCSDatabaseEntitys
{
    ...
    /// 调度任务
    /// </summary>
    [Table("WCSDispatchTask")]
    [EntityAutomaticRegister(Entity = typeof(DispatchTask), TableName = "WCSDispatchTask")]
    public class DispatchTask : SQLServerTableStringEntityBase
    {
        /// <summary>
        /// 仓库ID
        /// </summary>
