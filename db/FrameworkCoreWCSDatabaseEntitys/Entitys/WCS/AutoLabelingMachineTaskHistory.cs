...
namespace FrameworkCoreWCSDatabaseEntitys
{
    ...
    /// 贴标机历史任务
    /// </summary>
    [Table("WCSAutoLabelingMachineTaskHistory")]
    [EntityAutomaticRegister(Entity = typeof(AutoLabelingMachineTaskHistory), TableName = "WCSAutoLabelingMachineTaskHistory")]
    public class AutoLabelingMachineTaskHistory : SQLServerTableStringEntityBase
    {
        /// <summary>
        /// WMS任务号
        /// </summary>
