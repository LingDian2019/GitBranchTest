...
namespace FrameworkCoreWCSDatabaseEntitys
{
    ...
    /// 调度任务明细历史表
    /// </summary>
    [Table("WCSDispatchTaskItem_History")]
    [EntityAutomaticRegister(Entity = typeof(DispatchTaskItemHistory), TableName = "WCSDispatchTaskItem_History")]
    public class DispatchTaskItemHistory : SQLServerTableStringEntityBase
    {
        /// <summary>
        /// 主任务ID
        /// </summary>
