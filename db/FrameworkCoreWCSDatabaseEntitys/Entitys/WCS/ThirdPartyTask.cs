...
namespace FrameworkCoreWCSDatabaseEntitys
{
    ...
    /// 第三方任务
    /// </summary>
    [Table("WCSThirdPartyTask")]
    [EntityAutomaticRegister(Entity = typeof(ThirdPartyTask), TableName = "WCSThirdPartyTask")]
    public class ThirdPartyTask : SQLServerTableStringEntityBase
    {
        /// <summary>
        /// 仓库ID
        /// </summary>
